...
?>
    ...
    <p>
        ...
        Нажимайте последовательно ссылки трёх этапов, в каждом этапе подождите надпись "Обработка завершена". После
        третьего этапа можно будет скачать архив для печати кодов.
...
class CreateCodes extends SessionList
{
    ...
    function stage3()
    {
        ...
        $n = 1;
        for ($sheetn = 0; $sheetn < ceil(count($codes)/($rowcount*$colcount)); $sheetn++) {
