...
if (AdminAccess())
	DbgAll();
define("SITE_HTTP_ROOT","http://qrbattle.ru/");

/** @global $db */
$db = new mysqli_dbg("localhost", "user70878_qr", "BRmLM5GW","user70878_db_qrbattle");
...
$CODES=array(
	...
	CODE_GREEN=> array(
		'count'=>15,
		'name'=>'Зелёный код',
		'desc' => 'Зелёный код: начисление баллов выбранной команде'
	),
	CODE_BLUE => array(
		'count'=>10,
		'name'=>'Синий код',
		'desc' => 'Синий код: +20 баллов за правильный ответ выбранной команде'
	),
		CODE_RED => array(
			'count'=>10,
			'name'=>'Красный код',
	...
	CODE_HIDESCORE => array(
		...
		'desc' => 'Радужный код: скрыть или показать баллы выбранной команды в таблице результатов'
	),
);
